...
int main(int argc, char **argv){
  ...
  if (quiet_flag) printf("#1 F_p    2 N_p    3 r0     4 gr_min   5 gr_norm_factor   (6 <d_avg> +/- 7 sigma_{d_avg}) \t 8 max_neigh_dist \t (9 <d_pin> +/- 10 sigma_{d_pin})  (11 rho_digital  12 percent_edge 13 percent_center 14 first_max  15 last_max ) 16 N_v  17 bondLim \n ");//quiet flag
